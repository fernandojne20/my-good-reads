export const WISHLIST = [
  {
    ...
    publishedDate: new Date('2014-09-18T00:00:00.000Z'),
    coverUrl:
  ...
  },
  {
    ...
    publishedDate: new Date('2011-01-15T00:00:00.000Z'),
    coverUrl:
  ...
  },
  {
    ...
    publisher: '"O\'Reilly Media, Inc."',
    publishedDate: new Date('2008-05-08T00:00:00.000Z'),
    coverUrl:
  ...
  },
  {
    ...
    authors: ['thau!'],
    publisher: 'No Starch Press',
    publishedDate: new Date('2007-01-01T00:00:00.000Z'),
    coverUrl:
      'http://books.google.com/books/content?id=MrHaC5HAva8C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    description:
      'Recall from Chapter 6 that return causes <b>JavaScript</b> to exit the function (returning <br>\nany value that follows the word return; in this case we don&#39;t need a return value). <br>\nPutting the return in the if clause, as Space.com has done, forces the <b>JavaScript</b>&nbsp;...',
    isRead: false,
  },
  {
    id: 'vJGlu9t9LNYC',
    ...
    authors: ['David Flanagan'],
    publisher: '"O\'Reilly Media, Inc."',
    publishedDate: new Date('2002-01-01T00:00:00.000Z'),
    coverUrl:
      'http://books.google.com/books/content?id=vJGlu9t9LNYC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    description:
      'Java is a strongly typed language with a relatively large number of data types, <br>\nwhile <b>JavaScript</b> is an untyped language with a relatively small number of types. <br>\nBecause of this major structural difference between the two languages, one of the<br>\n&nbsp;...',
    isRead: true,
  },
  {
    id: 'QZtS4M835HgC',
    ...
    publishedDate: new Date('2011-01-15T00:00:00.000Z'),
    coverUrl:
      'http://books.google.com/books/content?id=QZtS4M835HgC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    description:
      'TABLE OF CONTENTS - Develop A One-Of-A-Kind CSS/JS-Based Game Portfolio - Five Useful Interactive CSS/jQuery Techniques Deconstructed - Create An Animated Bar Graph With HTML, CSS And jQuery - A Beginner’s Guide To jQuery-Based JSON API ...',
    isRead: true,
  },
  {
    id: 'OW_6BWEQAo4C',
    ...
    publisher: '"O\'Reilly Media, Inc."',
    publishedDate: new Date('2006-08-25T00:00:00.000Z'),
    coverUrl:
      'http://books.google.com/books/content?id=OW_6BWEQAo4C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    description:
      'Two things stand between the would-be scripter and an InDesign <b>Javascript</b>: <br>\nInDesign&#39;s object model and <b>JavaScript</b>. Though both are complex, once a few <br>\nhurdles are overcome, anyone can start writing scripts fairly quickly. This PDF <br>\nhopes&nbsp;...',
    isRead: false,
  },
  {
    id: 'CxY3lNQTATQC',
    ...
    authors: ['David Sawyer McFarland'],
    publisher: '"O\'Reilly Media, Inc."',
    publishedDate: new Date('2008-07-21T00:00:00.000Z'),
    coverUrl:
      'http://books.google.com/books/content?id=CxY3lNQTATQC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
    description:
      'However, window.onload=doQuiz merely points to the function and doesn&#39;t run it. <br>\nThe function only runs after the page loads. Confusing? Certainly, but that&#39;s how <br>\n<b>JavaScript</b> works. You&#39;ll learn about this topic in more depth on page 218.',
    isRead: true,
  },
  {
    id: 'qU3rAgAAQBAJ',
    ...
    publisher: '"O\'Reilly Media, Inc."',
    publishedDate: new Date('2014-02-25T00:00:00.000Z'),
    coverUrl:
